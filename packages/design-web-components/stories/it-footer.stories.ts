        ...
        <ul class="it-footer-small-prints-list list-inline mb-0 d-flex flex-column flex-md-row">
          ...
          <li class="list-inline-item">
            <a href="https://form.agid.gov.it/view/xyz"
              >Dichiarazione di accessibilità <span class="visually-hidden">(link esterno su sito AgID)</span></a
            >
          </li>
        </ul>
      </div>
...
const smallContent = html` <footer class="it-footer">
  <div class="it-footer-main">
    <div class="container">
      <section class="pb-4">
        <div class="row clearfix">
...
export const FooterCompatto: Story = {
  render: () => html`${smallContent}`,
  name: 'Footer compatto',
  parameters: {
    docs: {
      description: {
        story: `Il footer compatto è una versione semplificata del footer completo.
