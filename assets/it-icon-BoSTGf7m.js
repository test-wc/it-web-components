import{_ as t}from"./iframe-C-6rL3To.js";import{i as E,E as c,b as v,x as b,a as g}from"./lit-element-DvQWNfDj.js";import{n as l,r as A,e as R,t as I}from"./if-defined-BiCqEb5S.js";function m(_,r,i,o){var p=arguments.length,e=p<3?r:o,d;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(_,r,i,o);else for(var s=_.length-1;s>=0;s--)(d=_[s])&&(e=(p<3?d(e):p>3?d(r,i,e):d(r,i))||e);return p>3&&e&&Object.defineProperty(r,i,e),e}function u(_,r){if(typeof Reflect=="object"&&typeof Reflect.metadata=="function")return Reflect.metadata(_,r)}/**
 * @license
 *
...
.icon-white {
  fill: #fff !important;
}`;let a=class extends L{constructor(){super(...arguments),this.align="middle",this.label="",this.padded=!1}async updated(r){if(r.has("name")&&this.name){const i=O(this.name);if(i){const o=(await i()).default;this.parseAndStoreSvg(o)}}r.has("src")&&this.src&&await this.loadSvgFromUrl(this.src),r.has("label")&&this.handleTitleId(),(r.has("label")||r.has("size")||r.has("color")||r.has("padded")||r.has("role")||r.has("align"))&&this.updateSvgAttributes()}handleTitleId(){this.label?this.titleId||(this.titleId=`icon-label-${crypto.randomUUID()}`):this.titleId=void 0}async loadSvgFromUrl(r){try{const i=await fetch(r);if(!i.ok)throw new Error(`Failed to load SVG from ${r} (status: ${i.status})`);const o=await i.text();this.parseAndStoreSvg(o)}catch{this.svgElement=void 0,this.announceSvgLoadError()}}announceSvgLoadError(){this.dispatchEvent(new Event("error",{bubbles:!1,composed:!1,cancelable:!1}))}parseAndStoreSvg(r){const p=new DOMParser().parseFromString(r,"image/svg+xml").documentElement;this.svgElement=p,this.updateSvgAttributes()}applySvgAttributes(r){r.removeAttribute("width"),r.removeAttribute("height");const i=this.updateClasses(),o=this.ariaHidden!==null?this.ariaHidden:"true",p=o==="true"?null:this.role??"img";if(r.setAttribute("class",i),r.setAttribute("part","icon"),r.setAttribute("focusable","false"),p!=null&&r.setAttribute("role",p),r.setAttribute("aria-hidden",o),r.removeAttribute("aria-labelledby"),r.querySelectorAll("title").forEach(e=>e.remove()),this.label&&this.titleId){const e=document.createElementNS("http://www.w3.org/2000/svg","title");e.id=this.titleId,e.textContent=this.label,r.prepend(e),r.setAttribute("aria-labelledby",this.titleId)}}updateSvgAttributes(){this.svgElement&&this.applySvgAttributes(this.svgElement)}updateClasses(){return this.composeClass("icon",this.size?`icon-${this.size}`:"",this.color?`icon-${this.color}`:"",this.align?`align-${this.align}`:"",this.padded?"icon-padded":"")}handleSlotChange(){const i=this.slotEl.assignedNodes({flatten:!0}).find(o=>o.nodeType===Node.ELEMENT_NODE&&o.tagName.toLowerCase()==="svg");i&&this.applySvgAttributes(i)}render(){return b`
      <slot @slotchange=${this.handleSlotChange}>${this.svgElement?v`${this.svgElement}`:c}</slot>
    `}};a.styles=D;m([l({type:String}),u("design:type",String)],a.prototype,"size",void 0);m([l({type:String}),u("design:type",String)],a.prototype,"name",void 0);m([l({type:String}),u("design:type",String)],a.prototype,"color",void 0);m([l({type:String}),u("design:type",String)],a.prototype,"align",void 0);m([l({type:String,reflect:!0}),u("design:type",Object)],a.prototype,"label",void 0);m([l({type:Boolean}),u("design:type",Object)],a.prototype,"padded",void 0);m([l({type:String}),u("design:type",String)],a.prototype,"src",void 0);m([A(),u("design:type",HTMLElement)],a.prototype,"svgElement",void 0);m([R("slot"),u("design:type",HTMLSlotElement)],a.prototype,"slotEl",void 0);a=m([I("it-icon")],a);
