import{f as v,u as b,E,i as g,b as A,x as R,a as I}from"./lit-element-Dfkv_UsO.js";import{_ as t}from"./iframe-CzwxjRwd.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const T={attribute:!0,type:String,converter:b,reflect:!1,hasChanged:v},L=(o=T,r,i)=>{const{kind:e,metadata:a}=i;let _=globalThis.litPropertyMetadata.get(a);if(_===void 0&&globalThis.litPropertyMetadata.set(a,_=new Map),e==="setter"&&((o=Object.create(o)).wrapped=!0),_.set(i.name,o),e==="accessor"){const{name:m}=i;return{set(p){const n=r.get.call(this);r.set.call(this,p),this.requestUpdate(m,n,o)},init(p){return p!==void 0&&this.C(m,void 0,o,p),p}}}if(e==="setter"){const{name:m}=i;return function(p){const n=this[m];r.call(this,p),this.requestUpdate(m,n,o)}}throw Error("Unsupported decorator location: "+e)};function s(o){return(r,i)=>typeof i=="object"?L(o,r,i):((e,a,_)=>{const m=a.hasOwnProperty(_);return a.constructor.createProperty(_,e),m?Object.getOwnPropertyDescriptor(a,_):void 0})(o,r,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function D(o){return s({...o,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
.icon-white {
  fill: #fff !important;
}`;let u=class extends h{constructor(){super(...arguments),this.align="middle",this.label="",this.padded=!1}async updated(r){if(r.has("name")&&this.name){const i=y(this.name);if(i){const e=(await i()).default;this.parseAndStoreSvg(e)}}r.has("src")&&this.src&&await this.loadSvgFromUrl(this.src),r.has("label")&&this.handleTitleId(),(r.has("label")||r.has("size")||r.has("color")||r.has("padded")||r.has("role")||r.has("align"))&&this.updateSvgAttributes()}handleTitleId(){this.label?this.titleId||(this.titleId=`icon-label-${crypto.randomUUID()}`):this.titleId=void 0}async loadSvgFromUrl(r){try{const i=await fetch(r);if(!i.ok)throw new Error(`Failed to load SVG from ${r} (status: ${i.status})`);const e=await i.text();this.parseAndStoreSvg(e)}catch{this.svgElement=void 0,this.announceSvgLoadError()}}announceSvgLoadError(){this.dispatchEvent(new Event("error",{bubbles:!1,composed:!1,cancelable:!1}))}parseAndStoreSvg(r){const a=new DOMParser().parseFromString(r,"image/svg+xml").documentElement;this.svgElement=a,this.updateSvgAttributes()}applySvgAttributes(r){r.removeAttribute("width"),r.removeAttribute("height");const i=this.updateClasses();if(r.setAttribute("class",i),r.setAttribute("part","icon"),r.setAttribute("focusable","false"),r.setAttribute("role",this.role??"img"),r.setAttribute("aria-hidden",this.ariaHidden!==null?this.ariaHidden:"true"),r.removeAttribute("aria-labelledby"),r.querySelectorAll("title").forEach(e=>e.remove()),this.label&&this.titleId){const e=document.createElementNS("http://www.w3.org/2000/svg","title");e.id=this.titleId,e.textContent=this.label,r.prepend(e),r.setAttribute("aria-labelledby",this.titleId)}}updateSvgAttributes(){this.svgElement&&this.applySvgAttributes(this.svgElement)}updateClasses(){return this.composeClass("icon",this.size?`icon-${this.size}`:"",this.color?`icon-${this.color}`:"",this.align?`align-${this.align}`:"",this.padded?"icon-padded":"")}handleSlotChange(){const i=this.slotEl.assignedNodes({flatten:!0}).find(e=>e.nodeType===Node.ELEMENT_NODE&&e.tagName.toLowerCase()==="svg");i&&this.applySvgAttributes(i)}render(){return R`
      <slot @slotchange=${this.handleSlotChange}>${this.svgElement?A`${this.svgElement}`:E}</slot>
    `}};u.styles=k;l([s({type:String}),d("design:type",String)],u.prototype,"size",void 0);l([s({type:String}),d("design:type",String)],u.prototype,"name",void 0);l([s({type:String}),d("design:type",String)],u.prototype,"color",void 0);l([s({type:String}),d("design:type",String)],u.prototype,"align",void 0);l([s({type:String,reflect:!0}),d("design:type",Object)],u.prototype,"label",void 0);l([s({type:Boolean}),d("design:type",Object)],u.prototype,"padded",void 0);l([s({type:String}),d("design:type",String)],u.prototype,"src",void 0);l([D(),d("design:type",HTMLElement)],u.prototype,"svgElement",void 0);l([V("slot"),d("design:type",HTMLSlotElement)],u.prototype,"slotEl",void 0);u=l([O("it-icon")],u);export{s as n,x as o,O as t};
